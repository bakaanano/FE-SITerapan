      ...
      <section className="popular-books">
        <div className="popular-books-container">
          <div className="section-header">
            ...
            <a href="#lihat-semua" className="lihat-semua">Lihat Semua ___</a>
          </div>
            ...
            {[1, 2, 3, 4, 5].map((item) => (
              <div key={item} className="book-card">
                ...
                <div className="book-info">
                  <h3 className="book-title">Judul Buku I</h3>
                  <p className="book-author">Penulis</p>
                  <button className="book-btn">Lihat Detail</button>
                </div>
              </div>
            ))}
          </div>
